...
const Cartoon = (() => {
  ...
  const ITEM = {
    ...
    twostory: `<rect x="24" y="38" width="52" height="50" fill="#ffe1b0"/><path d="M16,40 L50,16 L84,40 Z" fill="#e07a5f"/><rect x="32" y="46" width="12" height="12" rx="2" fill="#bfe6ff"/><rect x="56" y="46" width="12" height="12" rx="2" fill="#bfe6ff"/><rect x="42" y="66" width="16" height="22" rx="2" fill="#b5824f"/><circle cx="55" cy="78" r="1.6" fill="#ffd84d" stroke="none"/>`,
    cabin: `<rect x="26" y="46" width="48" height="42" fill="#c99a5e"/><path d="M20,48 L50,24 L80,48 Z" fill="#7cae5a"/><g stroke="#a5794a" stroke-width="2"><path d="M26,58 L74,58 M26,68 L74,68 M26,78 L74,78"/></g><rect x="44" y="70" width="14" height="18" rx="2" fill="#8a5a2b"/><circle cx="50" cy="40" r="6" fill="#bfe6ff"/>`,
    castle: `<rect x="24" y="44" width="52" height="44" fill="#dfe4ea"/><rect x="20" y="34" width="12" height="20" fill="#dfe4ea"/><rect x="68" y="34" width="12" height="20" fill="#dfe4ea"/><g stroke="none" fill="#dfe4ea"><rect x="20" y="30" width="4" height="6"/><rect x="26" y="30" width="4" height="6"/><rect x="68" y="30" width="4" height="6"/><rect x="74" y="30" width="4" height="6"/></g><path d="M26,34 L26,26 L34,30 Z" fill="#ff6b6b"/><path d="M74,34 L74,26 L66,30 Z" fill="#ff6b6b"/><rect x="42" y="64" width="16" height="24" rx="8" fill="#9a6fd0"/><rect x="34" y="52" width="10" height="10" fill="#bfe6ff"/><rect x="56" y="52" width="10" height="10" fill="#bfe6ff"/>`,
  };
  ...
  const MOTIF = {
    ...
    window: svg(`<rect x="8" y="10" width="84" height="78" rx="4" fill="#bfe6ff"/><g stroke="none"><rect x="8" y="10" width="84" height="46" fill="#cfeeff"/><circle cx="30" cy="28" r="9" fill="#ffe07a"/><ellipse cx="66" cy="24" rx="13" ry="6" fill="#fff"/><path d="M8,58 Q30,46 52,58 Q72,68 92,54 L92,88 L8,88 Z" fill="#a7e07a"/><path d="M8,66 Q34,56 60,66 Q80,72 92,64 L92,88 L8,88 Z" fill="#8fd36a"/></g><path d="M50,12 L50,86 M12,49 L88,49" stroke-width="5"/><rect x="4" y="6" width="92" height="86" rx="6" fill="none" stroke-width="6"/><rect x="2" y="88" width="96" height="9" rx="3" fill="#e0c090"/>`, '0 0 100 100'),
    windowNight: svg(`<rect x="8" y="10" width="84" height="78" rx="4" fill="#3a3a72"/><g stroke="none"><path d="M70,22 A14,14 0 1,0 70,50 A11,11 0 1,1 70,22 Z" fill="#fdf0b0"/><circle cx="26" cy="26" r="1.6" fill="#fff"/><circle cx="40" cy="20" r="1.4" fill="#fff"/><circle cx="34" cy="40" r="1.4" fill="#fff"/><path d="M8,64 Q34,54 60,64 Q80,70 92,62 L92,88 L8,88 Z" fill="#2f5a3a"/></g><path d="M50,12 L50,86 M12,49 L88,49" stroke-width="5"/><rect x="4" y="6" width="92" height="86" rx="6" fill="none" stroke-width="6"/><rect x="2" y="88" width="96" height="9" rx="3" fill="#c0a090"/>`, '0 0 100 100'),
    shelf: svg(`<g stroke="none"><rect x="14" y="20" width="8" height="22" fill="#ff8fb0"/><rect x="24" y="24" width="8" height="18" fill="#7ecb68"/><rect x="34" y="20" width="8" height="22" fill="#ffd84d"/><rect x="44" y="26" width="7" height="16" fill="#8fcbe0"/></g><path d="M62,42 Q62,24 74,24 Q86,24 86,42Z" fill="#9ad0e0"/><rect x="6" y="42" width="88" height="8" rx="2" fill="#c08a55"/>`, '0 0 100 60'),
    hanglamp: svg(`<path d="M50,2 L50,26" stroke-width="4"/><path d="M32,50 Q32,26 50,26 Q68,26 68,50 Z" fill="#ffe08a"/><ellipse cx="50" cy="50" rx="18" ry="5" fill="#ffd24d"/>`, '0 0 100 70'),
    garland: svg(`<path d="M4,10 Q50,40 96,10" fill="none" stroke-width="3"/><g stroke="none"><path d="M20,20 l4,8 -8,0z" fill="#ff8fb0"/><path d="M40,26 l4,8 -8,0z" fill="#ffd84d"/><path d="M60,26 l4,8 -8,0z" fill="#7ecb68"/><path d="M80,20 l4,8 -8,0z" fill="#8fcbe0"/></g>`, '0 0 100 40'),
  ...
  const THEMES = [
    ...
    { id: 'cozy', type: 'indoor', name: '아늑한 방', emoji: '🛋️',
      css: 'linear-gradient(#ffe6c8 0%, #ffe6c8 55%, #cf9d63 55.5%, #d9a86a 57%, #c98f52 100%)',
      fixtures: [ { m: 'window', x: 0.16, y: 0.3, w: 150 }, { m: 'shelf', x: 0.38, y: 0.28, w: 150 }, { m: 'picture', x: 0.56, y: 0.24, w: 88 }, { m: 'clock', x: 0.68, y: 0.22, w: 74 }, { m: 'hanglamp', x: 0.5, y: 0.1, w: 90 }, { m: 'door', x: 0.9, y: 0.58, w: 120 }, { m: 'potplant', x: 0.8, y: 0.78, w: 96 }, { m: 'rug', x: 0.45, y: 0.86, w: 260 } ] },
    { id: 'treehouse', type: 'indoor', name: '나무집', emoji: '🌳',
      css: 'linear-gradient(#d7a86a 0%, #d7a86a 55%, #a5734255 55.5%, #b5824f 57%, #a57342 100%)',
      fixtures: [ { m: 'window', x: 0.18, y: 0.3, w: 150 }, { m: 'shelf', x: 0.42, y: 0.28, w: 150 }, { m: 'bush', x: 0.6, y: 0.24, w: 96 }, { m: 'picture', x: 0.72, y: 0.24, w: 86 }, { m: 'potplant', x: 0.85, y: 0.78, w: 100 }, { m: 'rug', x: 0.48, y: 0.86, w: 240 } ] },
    { id: 'living', type: 'indoor', name: '이층집 거실', emoji: '🏠',
      css: 'linear-gradient(#eef0e2 0%, #eef0e2 55%, #bfa079aa 55.5%, #cdb08a 57%, #bfa079 100%)',
      fixtures: [ { m: 'window', x: 0.16, y: 0.28, w: 175 }, { m: 'window', x: 0.44, y: 0.28, w: 175 }, { m: 'picture', x: 0.66, y: 0.22, w: 90 }, { m: 'clock', x: 0.76, y: 0.2, w: 74 }, { m: 'door', x: 0.92, y: 0.58, w: 120 }, { m: 'potplant', x: 0.86, y: 0.78, w: 100 }, { m: 'rug', x: 0.42, y: 0.86, w: 300 } ] },
    { id: 'princess', type: 'indoor', name: '공주방', emoji: '👑',
      css: 'linear-gradient(#ffe0ef 0%, #ffe0ef 55%, #d98cb066 55.5%, #e8a0c0 57%, #d98cb0 100%)',
      fixtures: [ { m: 'window', x: 0.16, y: 0.3, w: 150 }, { m: 'garland', x: 0.45, y: 0.12, w: 220 }, { m: 'canopy', x: 0.68, y: 0.52, w: 190 }, { m: 'heartpic', x: 0.36, y: 0.26, w: 86 }, { m: 'shelf', x: 0.5, y: 0.3, w: 140 }, { m: 'potplant', x: 0.88, y: 0.78, w: 96 }, { m: 'rug', x: 0.4, y: 0.87, w: 240 } ] },
  ];
  ...
  const SHOP = [
    ...
    { id: 'house', cost: 15, where: 'out' }, { id: 'twostory', cost: 22, where: 'out' }, { id: 'cabin', cost: 18, where: 'out' }, { id: 'castle', cost: 30, where: 'out' }, { id: 'snowman', cost: 6, where: 'out' }, { id: 'rainbow', cost: 10, where: 'out' },
